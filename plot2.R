##  ---
##  title: "Exploratory Data Analysis: peer assignment 1: plot 2"
##  author: "DianeCS"
...
## make and store plot 2
HPCselectedDates$DateTimeConcat <- paste(HPCselectedDates$Date, HPCselectedDates$Time)
HPCselectedDates$DateTime2 <- strptime(HPCselectedDates$DateTimeConcat
                                       , "%d/%m/%Y %H:%M:%S")
